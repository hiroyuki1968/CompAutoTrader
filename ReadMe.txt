========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : CompAutoTrader
========================================================================


AppWizard が生成した CompAutoTrader には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには CompAutoTrader を構成している各ファイルの概要説明が含まれています。
...
CompAutoTrader.h
    ...
    みます） をインクルードし、また CCompAutoTraderApp アプリケーションクラスを宣
    言します。

CompAutoTrader.cpp
    このファイルは CCompAutoTraderApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\CompAutoTrader.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル CompAutoTrader.rc によってインクルード
    されます。

res\CompAutoTrader.rc2
...
CompAutoTraderDlg.h, CompAutoTraderDlg.cpp - ダイアログ
    これらのファイルは CCompAutoTraderDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な CompAutoTrader.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) CompAutoTrader.pch 
